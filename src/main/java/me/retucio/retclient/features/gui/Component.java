...
import me.retucio.retclient.features.gui.items.buttons.Button;
...
public class Component extends Feature {
    ...
    public void drawScreen(DrawContext context, int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) GUI.getClickGui().getTextOffset(), -1);
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            GUI.getClickGui().getComponents().forEach(component -> {if (component.drag) component.drag = false;});
