...
import me.retucio.retclient.manager.ConfigManager;
...
public class ModuleCommand extends Command {
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : RetClient.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                
                for (Module module1 : RetClient.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = RetClient.moduleManager.getModuleByDisplayName(commands[0]);
        
        if (module == null) {
            module = RetClient.moduleManager.getModuleByName(commands[0]);
