package me.retucio.retclient.features.modules;
...
public class Module extends Feature implements Jsonable {
    ...
    public void setDisplayName(String name) {
        Module module = RetClient.moduleManager.getModuleByDisplayName(name);
        Module originalModule = RetClient.moduleManager.getModuleByName(name);
