package me.retucio.retclient.features.settings;
...
public class EnumConverter extends Converter<Enum, JsonElement> {
    ...
    private final Class<? extends Enum> clazz; // alternative names: klass or сlass (with a cyrillic C), better than adding random junk like _
