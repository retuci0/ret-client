...
public class AltScreen extends Screen {
	...
	public List<Alt> getAltList() {
		return Main.getInstance().altManager.getAlts();
	}
	...
	public void loginToSelected() {
		...
		if (alt.isCracked()) {
			Main.getInstance().altManager.loginCracked(alt.getEmail());
		} else {
			Main.getInstance().altManager.login(alt);
		}
	}
	...
	public void deleteSelected() {
		...
		Main.getInstance().altManager.removeAlt(alt);
		this.refreshAltList();
	}
}
