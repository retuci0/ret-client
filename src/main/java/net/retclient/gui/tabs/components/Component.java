...
public abstract class Component implements IGuiElement, MouseMoveListener {
	...
	public void setVisible(boolean bool) {
		...
		if (bool) {
			Main.getInstance().eventManager.AddListener(MouseMoveListener.class, this);
		} else {
			Main.getInstance().eventManager.RemoveListener(MouseMoveListener.class, this);
		}
	...
	public void OnMouseMove(MouseMoveEvent mouseMoveEvent) {
		if (!visible || (parent != null && !Main.getInstance().hudManager.isClickGuiOpen())) {
			this.hovered = false;
		} else {
